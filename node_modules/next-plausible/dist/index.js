...
const getApiEndpoint = (options) => { var _a; return `/${(_a = options.subdirectory) !== null && _a !== void 0 ? _a : 'proxy'}/api/event`; };
function withPlausibleProxy(options = {}) {
    return (nextConfig) => (Object.assign(Object.assign({}, nextConfig), { publicRuntimeConfig: Object.assign(Object.assign({}, nextConfig.publicRuntimeConfig), { nextPlausibleProxyOptions: options }), rewrites: () => __awaiter(this, void 0, void 0, function* () {
            var _a;
...
function PlausibleProvider(props) {
    ...
    const proxyOptions = (_b = (_a = getConfig__default["default"]()) === null || _a === void 0 ? void 0 : _a.publicRuntimeConfig) === null || _b === void 0 ? void 0 : _b.nextPlausibleProxyOptions;
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(Head__default["default"], null,
            enabled && (React__default["default"].createElement("script", Object.assign({ async: true, defer: true, "data-api": proxyOptions ? getApiEndpoint(proxyOptions) : undefined, "data-domain": props.domain, "data-exclude": props.exclude, src: (proxyOptions ? '' : domain) +
                    getScriptPath(Object.assign(Object.assign({}, proxyOptions), { scriptName: proxyOptions
                            ? proxyOptions.scriptName
                            : getRemoteScriptName(domain, props.selfHosted) }), props.trackLocalhost ? 'local' : null, props.manualPageviews ? 'manual' : null, props.trackOutboundLinks ? 'outbound-links' : null, props.exclude ? 'exclusions' : null), integrity: props.integrity, crossOrigin: props.integrity ? 'anonymous' : undefined }, props.scriptProps))),
